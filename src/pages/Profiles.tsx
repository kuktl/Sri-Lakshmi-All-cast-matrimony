  ...
  return (
    <div className="bg-cream-50 font-sans min-h-screen">
      ...
      <section 
        ...
        style={{
          backgroundImage: "linear-gradient(to bottom, rgba(30, 8, 8, 0.90), rgba(20, 5, 5, 0.85)), url('https://images.unsplash.com/photo-1621184455862-c163dfb30e0f?w=1600&auto=format&fit=crop&q=80')"
        }}
      >
