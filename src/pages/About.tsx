  ...
  return (
    <div className="bg-cream-50 font-sans">
      ...
      <section 
        ...
        style={{
          backgroundImage: "linear-gradient(to bottom, rgba(15, 10, 10, 0.88), rgba(28, 12, 12, 0.84)), url('https://images.unsplash.com/photo-1595777457583-95e059d581b8?w=1600&auto=format&fit=crop&q=80')"
        }}
      >
            ...
            <div className="md:col-span-5 relative font-sans">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-double border-stone-200 aspect-[4/3] sm:aspect-square bg-stone-100">
                <img 
                  ...
                  alt="Telugu Traditional Wedding Ceremony Hands" 
