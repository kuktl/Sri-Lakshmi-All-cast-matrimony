  ...
  return (
    <div className="bg-cream-50 font-sans pb-16 animate-none">
      ...
      <section 
        ...
        style={{
          backgroundImage: "linear-gradient(to bottom, rgba(15, 10, 10, 0.88), rgba(28, 12, 12, 0.84)), url('https://images.unsplash.com/photo-1511285560929-80b456fea0bc?w=1600&auto=format&fit=crop&q=80')"
        }}
      >
