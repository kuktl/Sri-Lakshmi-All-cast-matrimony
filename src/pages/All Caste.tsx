  ...
  return (
    <div className="bg-cream-50 font-sans">
      ...
      <section 
        ...
        style={{
          backgroundImage: "linear-gradient(to bottom, rgba(15, 10, 10, 0.88), rgba(28, 12, 12, 0.84)), url('https://images.unsplash.com/photo-1583939003579-730e3918a45a?w=1600&auto=format&fit=crop&q=80')"
        }}
      >
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative aspect-[4/3] rounded-3xl overflow-hidden border-4 border-double border-stone-200 shadow-2xl bg-stone-100">
              <img 
                src="https://images.unsplash.com/photo-1610030469668-93535c17b6b3?w=600&auto=format&fit=crop&q=80" 
                alt="Traditional Indian Marriage Blessings Rice" 
