        ...
        <div className={`grid grid-cols-1 lg:grid-cols-12 gap-12 items-center ${
          ...
          <div className="lg:col-span-7 flex justify-center">
            ...
            >
              ...
              {/* Main Couch Speaker photo with fake artificial green grass back wall exact match */}
              <img 
                src="https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=1000&auto=format&fit=crop&q=80" 
              ...
              <div className="absolute inset-x-0 bottom-12 top-0 flex items-center justify-center">
                ...
                <div className="absolute left-[35%] bottom-[10%] w-[45%] h-[75%] opacity-90">
                  <div className="w-full h-full bg-cover bg-center rounded-xl scale-x-[-1]" style={{
                    backgroundImage: "url('https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=400&auto=format&fit=crop&q=80')"
                  }}></div>
                </div>
