...
export default function HeroSection({ onTalkToExpertClick, onRegisterClick }: HeroSectionProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Smooth scroll to top/success window or let them click WhatsApp if they want to speed it up
    setTimeout(() => {
  ...
  return (
    <section 
      id="hero-section" 
      className="relative min-h-[90vh] flex items-center justify-start bg-cover bg-center lg:bg-[right_center] overflow-hidden py-12 sm:py-20 lg:py-28"
      style={{
        backgroundImage: "linear-gradient(to right, rgba(20, 8, 8, 0.92) 0%, rgba(25, 12, 12, 0.85) 45%, rgba(20, 8, 8, 0.40) 100%), url('https://images.unsplash.com/photo-1607190074257-dd4b7af0309f?w=1600&auto=format&fit=crop&q=80')"
      }}
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10 font-sans">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="col-span-12 lg:col-span-6 xl:col-span-5" id="hero-right-form-wrapper">
            <div className="bg-stone-900/80 backdrop-blur-md rounded-2xl border border-white/10 p-6 sm:p-8 shadow-2xl text-white relative overflow-hidden">
              ...
              {!isSubmitted ? (
                <>
                  ...
                  <h2 className="font-serif text-2xl sm:text-3xl font-extrabold text-white tracking-tight leading-tight mb-2">
                    {t('hero.form.title', 'Register Your Profile Today', 'ఈరోజే మీ ప్రొఫైల్‌ను నమోదు చేసుకోండి')}
                  </h2>
                  <p className="text-stone-300 text-xs sm:text-sm mb-6 font-normal">
                    {t(
                      'hero.form.desc',
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                      ...
                      <input 
                        ...
                        placeholder={t('hero.form.namePlaceholder', 'e.g. Srikant Reddy / Nagaraju Goud', 'ఉదా. శ్రీకాంత్ రెడ్డి / నాగరాజు గౌడ్')}
                        className="w-full text-xs p-3 rounded-xl border border-white/15 focus:outline-none focus:ring-1 focus:ring-emerald-500 bg-white/5 text-white placeholder-stone-400"
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <select 
                          ...
                          className="w-full text-xs p-3 rounded-xl border border-white/15 focus:outline-none focus:ring-1 focus:ring-emerald-500 bg-stone-900 text-white cursor-pointer"
                        >
                    ...
                    <button
                      type="submit"
                      className="w-full mt-4 py-4 px-4 bg-[#10b981] hover:bg-[#059669] text-white font-bold text-sm sm:text-base rounded-xl cursor-pointer shadow-lg active:scale-[0.98] transition-all duration-200 flex items-center justify-center gap-2"
                    >
